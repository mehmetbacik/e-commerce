                    ...
                    <div class="x_content">
                        ...
                        <form action="../system/work.php" method="POST" id="demo-form2" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="slider_name" placeholder="Slider Name" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slider_url">URL</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="slider_link" placeholder="Slider Link" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slider_order">Order</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="slider_order" placeholder="Slider Order" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="slideradd" class="btn btn-primary">Add</button>
                                </div>
                            </div>
                        </form>
                    </div>
